...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //└────────┴────────┴────────┴───┬────┴───┬────┴───┬────┴───┬────┘        └───┬────┴───┬────┴───┬────┴───┬────┴────────┴────────┴────────┘
                                    KC_LCTL, KC_SPC,   MO(2),                    MO(3),  MO(1),   MO(2)
                                // └────────┴────────┴────────┘                 └────────┴────────┴────────┘
  ),
...
//         switch(get_highest_layer(layer_state|default_layer_state)) {
//             case 1:
//                 rgb_matrix_set_color(i,152,57,3);
//                 break;
//             case 2:
//                 rgb_matrix_set_color(i,1,70,3);
//                 break;
//             case 5:
//                 rgb_matrix_set_color(i,174,0,97);
//                 break;
//             default:
//                 break;
//         }
...
//       hsv = {120,60,96};
//    }
//    if (layer_state_is(layer_state, 5)) {
//       hsv = {336,50,96};
//    }
